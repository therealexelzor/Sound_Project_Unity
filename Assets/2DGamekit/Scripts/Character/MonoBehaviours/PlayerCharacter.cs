...
namespace Gamekit2D
{
    ...
    public class PlayerCharacter : MonoBehaviour
    {
        ...
        public TileBase TilesetRockRules { get; private set; }
        ...
        public void Unpause()
        {
            ...
            AudioManager.Instance.StopMusicPause();
        ...
        public void CheckForPushing()
        {
            ...
            {//we changed pushable (or don't have one anymore), stop the old one sound
                ...
                audioManager.PlayBoxPush(false);
            }
